 ...
 * @author Lenovo G40
 */
@WebServlet(name = "ProblemList1", urlPatterns = {"/ProblemList1"})
public class ProblemList1 extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            request.getRequestDispatcher("problemlist_1.jsp").forward(request, response);
//           
        }
    }
